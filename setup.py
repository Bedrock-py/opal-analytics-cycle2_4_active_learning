...
setup(
    ...
    description='Gallup Cycle 2 Analysis Active Learning',
    long_description=long_description,

    # The project's main homepage.
    url='https://github.com/bedrock-py/opal-ingest-cycle2_4_active_learning',
    ...
    packages=['opals.cycle2_4_active_learning'],
